// zonta-site/src/pages/Admin/Memberships/Memberships.tsx
...
} from "./AddMembershipModal";
import EditMembershipModal, { type Membership } from "./EditMembershipModal";
...
export default function Memberships() {
  ...
  const handleDelete = (membershipId: string, membershipTitle: string) => {
    if (confirm(`Are you sure you want to delete "${membershipTitle}"?`)) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <AddMembershipModal
        ...
        onSubmit={(membership) => createMutation.mutate(membership)}
